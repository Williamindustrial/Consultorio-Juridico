 ...
 * @author Asus
 */
public class consultarEdades1 {

    ArrayList<ArrayList> matrix = new ArrayList<>();
    String fecha1, fecha2, area;

    public consultarEdades1(String fecha1, String fecha2, String area) throws SQLException {
        this.fecha1 = fecha1;
        this.fecha2 = fecha2;
        this.area = area;
        consultar(0, 26);
    ...
    private void consultar(int edad1, int edad2) throws SQLException {
        String consulta = "SELECT usuarioatendido.Asunto,fichabibliografica.edad,COUNT(fichabibliografica.edad) FROM fichabibliografica LEFT JOIN usuarioatendido on fichabibliografica.radicadoInterno= usuarioatendido.radicado WHERE usuarioatendido.fecha BETWEEN ? AND ?  AND usuarioatendido.area=? AND fichabibliografica.edad BETWEEN ? and ?";
