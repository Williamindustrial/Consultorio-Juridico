 ...
 * @author Asus
 */
public class consultarEstadisticaAsuntos1 {
    ArrayList<ArrayList> matrix= new ArrayList<>();
    public consultarEstadisticaAsuntos1(String fecha1, String fecha2,String area, String consulta) throws SQLException {
